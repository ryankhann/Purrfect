...
const Siamese = () => {
  ...
  // Kittens data (2 Siamese)
  const kittens = [
    {
      id: 'siamese-ming',
      name: 'Ming',
      age: '11 weeks',
      description: 'Seal Point • Vocal & loving',
      price: 1500,
    ...
    },
    {
      ...
      name: 'Anong',
      age: '13 weeks',
      description: 'Blue Point • Elegant companion',
      price: 1700,
      img: '/images/Siamese-1.png',
      sex: 'Female',
      soldOut: false,
    },
  ];
  ...
  const faqs = [
    {
      question: '🗣️ Are Siamese really that vocal?',
      answer:
        'Yes! They love to "talk" and will happily chat with you throughout the day.',
    },
    {
      question: '👶 Good with children?',
      answer:
        'Excellent. They are playful, social, and thrive in active households.',
    },
    {
      question: '💉 Health guarantee?',
      answer:
        'All Siamese kittens come with a 2-year genetic health guarantee, vaccinations, and microchip.',
    },
  ];

  // Gallery images (just the two)
  const galleryImages = [
    '/images/Siamese.png',
    ...
    <div className="font-sans bg-[#faf8f6] text-[#0f2a2f] overflow-x-hidden relative">
      ...
      <section className="relative h-[85vh] overflow-hidden flex items-center justify-center">
        <video
          ...
          loop
          playsInline
          src="/videos/Siamese.mp4"
          poster="/images/Siamese/Siamese-banner.jpg"
        />
        ...
        >
          <span className="inline-block bg-white/20 backdrop-blur-md px-6 py-2 rounded-full text-xs font-semibold uppercase tracking-[1px] mb-6 border border-white/30">
            <i className="fas fa-crown"></i> SIAMESE • ROYAL CHATTERBOXES
          </span>
          ...
          <p className="text-base font-normal opacity-90 max-w-xl mx-auto mb-8 leading-relaxed">
            Sophisticated, talkative, and deeply devoted to their people.
          </p>
          <a
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div data-aos="fade-right">
            <h2 className="text-3xl font-bold text-[#1f4a4a] mb-4 relative inline-block after:content-[''] after:absolute after:-bottom-2 after:left-0 after:w-[60px] after:h-[2px] after:bg-[#2a6b6b]">
              Siamese <span className="font-normal">Charm</span>
            </h2>
            <p className="my-6 leading-relaxed text-[#3c5c5c]">
              Siamese cats are famous for their striking blue almond‑shaped eyes and short, glossy coats. They're incredibly social, form strong bonds with one person, and will follow you everywhere. Their vocal nature makes them wonderful conversationalists.
            </p>
            <div className="flex flex-wrap gap-4 mt-4">
              ...
              <span className="bg-[#eef5f2] px-4 py-1.5 rounded-full text-sm font-semibold text-[#2a6b6b]">
                <i className="fas fa-microphone"></i> Vocal
              </span>
              <span className="bg-[#eef5f2] px-4 py-1.5 rounded-full text-sm font-semibold text-[#2a6b6b]">
                <i className="fas fa-child"></i> Playful
              </span>
            </div>
            <p className="mt-5">✔️ Weight: 6-12 lbs | Lifespan: 12-15 years</p>
          </div>
      ...
      <div className="max-w-7xl mx-auto my-20 px-6" id="kittens-for-sale">
        <div className="text-center mb-12" data-aos="fade-up">
          ...
          <h2 className="text-[clamp(1.8rem,4vw,2.5rem)] font-bold">Choose Your Siamese</h2>
        </div>
      ...
      <div className="max-w-5xl mx-auto my-20 px-6">
        <div className="text-center mb-12" data-aos="fade-up">
          ...
          <h2 className="text-[clamp(1.8rem,4vw,2.5rem)] font-bold">Siamese Insights</h2>
        </div>
      ...
      <div className="text-center py-8 text-[#8aa9a4]">
        ...
        <p className="mt-8">
          <i className="fas fa-cat"></i> Purrfect Siamese Breeder – TICA registered cattery
        </p>
      </div>
