...
const Persian = () => {
  ...
  // Kittens data (only 2 Persians)
  const kittens = [
    {
      id: 'persian-luna',
      name: 'Luna',
      age: '12 weeks',
      description: 'White Persian • Calm & loving',
      price: 1800,
      img: '/images/persian/Persian-1.jpg',
      sex: 'Female',
      soldOut: false,
    },
    {
      ...
      name: 'Simba',
      age: '14 weeks',
      description: 'Golden Shaded • Playful cuddler',
      price: 2000,
      img: '/images/persian/Persian-2.jpg',
      sex: 'Male',
      soldOut: false,
    },
  ];
  ...
  const faqs = [
    {
      question: '🐾 Do Persians require a lot of grooming?',
      answer:
        'Yes, their long coat needs daily brushing to prevent mats. We provide a grooming guide with every adoption.',
    },
    {
      question: '🏠 Are they suited for apartments?',
      answer:
        'Absolutely! Persians are calm and love lounging, making them perfect indoor companions.',
    },
    {
      question: '💉 Health guarantee?',
      answer:
        'All our Persians come with a 2-year genetic health guarantee, vaccinations, and microchip.',
    },
  ];

  // Gallery images (just the two we have)
  const galleryImages = [
    '/images/persian/Persian-3.png',
    '/images/persian/Persian-4.jpg',
  ];
    ...
    <div className="font-sans bg-[#faf8f6] text-[#0f2a2f] overflow-x-hidden relative">
      ...
      <section className="relative h-[85vh] overflow-hidden flex items-center justify-center">
        <video
          ...
          loop
          playsInline
          src="/videos/Persian.mp4"
        />
        <div
          className="absolute top-0 left-0 w-full h-full bg-cover bg-center z-0"
          style={{ backgroundImage: `url('/images/Persian/Persian-banner.jpg')` }}
        />
        ...
        >
          <span className="inline-block bg-white/20 backdrop-blur-md px-6 py-2 rounded-full text-xs font-semibold uppercase tracking-[1px] mb-6 border border-white/30">
            <i className="fas fa-crown"></i> PERSIAN • LUXURIOUS COMPANIONS
          </span>
          ...
          <p className="text-base font-normal opacity-90 max-w-xl mx-auto mb-8 leading-relaxed">
            The epitome of elegance with a sweet, gentle soul.
          </p>
          <a
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div data-aos="fade-right">
            <h2 className="text-3xl font-bold text-[#1f4a4a] mb-4 relative inline-block after:content-[''] after:absolute after:-bottom-2 after:left-0 after:w-[60px] after:h-[2px] after:bg-[#2a6b6b]">
              Persian <span className="font-normal">Temperament</span>
            </h2>
            <p className="my-6 leading-relaxed text-[#3c5c5c]">
              Persians are the quiet, dignified aristocrats of the cat world. They adore serene environments and form deep bonds with their humans, enjoying gentle play and lots of lap time. Their luxurious long coat requires regular grooming, but their calm, sweet nature makes it all worthwhile.
            </p>
            <div className="flex flex-wrap gap-4 mt-4">
              ...
              <span className="bg-[#eef5f2] px-4 py-1.5 rounded-full text-sm font-semibold text-[#2a6b6b]">
                <i className="fas fa-feather"></i> Gentle
              </span>
              <span className="bg-[#eef5f2] px-4 py-1.5 rounded-full text-sm font-semibold text-[#2a6b6b]">
                <i className="fas fa-couch"></i> Laid‑back
              </span>
            </div>
            <p className="mt-5">✔️ Weight: 7-12 lbs | Lifespan: 12-17 years</p>
          </div>

          {/* 2x2 gallery – only two images, arranged in one row */}
      ...
      <div className="max-w-7xl mx-auto my-20 px-6" id="kittens-for-sale">
        <div className="text-center mb-12" data-aos="fade-up">
          ...
          <h2 className="text-[clamp(1.8rem,4vw,2.5rem)] font-bold">Adopt a Persian</h2>
        </div>
      ...
      <div className="max-w-5xl mx-auto my-20 px-6">
        <div className="text-center mb-12" data-aos="fade-up">
          ...
          <h2 className="text-[clamp(1.8rem,4vw,2.5rem)] font-bold">Persian Insights</h2>
        </div>
      ...
      <div className="text-center py-8 text-[#8aa9a4]">
        ...
        <p className="mt-8">
          <i className="fas fa-cat"></i> Purrfect Persian Breeder – TICA registered cattery
        </p>
      </div>
