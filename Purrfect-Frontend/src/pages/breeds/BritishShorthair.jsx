...
const BritishShorthair = () => {
  ...
  // Kittens data (2 British Shorthairs)
  const kittens = [
    {
      id: 'bsh-winston',
      name: 'Winston',
      age: '15 weeks',
      description: 'Blue • Plush teddy bear',
      price: 2200,
    ...
    },
    {
      ...
      name: 'Margot',
      age: '14 weeks',
      description: 'Lilac • Calm & dignified',
      price: 2400,
      img: '/images/BritishShorthair-1.png',
      sex: 'Female',
      soldOut: false,
    },
  ];
  ...
  const faqs = [
    {
      question: '🧸 Are British Shorthairs cuddly?',
      answer:
        'They are affectionate on their own terms. Expect a loyal companion who loves to sit beside you rather than on your lap.',
    },
    {
      question: '🏠 Apartment‑friendly?',
      answer:
        'Absolutely. They are calm, quiet, and adapt well to indoor living.',
    },
    {
      question: '💉 Health guarantee?',
      answer:
        'All British Shorthairs come with a 2-year genetic health guarantee, vaccinations, and microchip.',
    },
  ];

  // Gallery images
  const galleryImages = [
    '/images/BritishShortHair.png',
    '/images/bs-eye.jpg',
  ];
    ...
    <div className="font-sans bg-[#faf8f6] text-[#0f2a2f] overflow-x-hidden relative">
      ...
      <section className="relative h-[85vh] overflow-hidden flex items-center justify-center">
        <video
          ...
          loop
          playsInline
          src="/videos/BritishShorthair.mp4"
          poster="/images/BritishShorthair/BritishShorthair-banner.jpg"
        />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div data-aos="fade-right">
            <h2 className="text-3xl font-bold text-[#1f4a4a] mb-4 relative inline-block after:content-[''] after:absolute after:-bottom-2 after:left-0 after:w-[60px] after:h-[2px] after:bg-[#2a6b6b]">
              British Shorthair <span className="font-normal">Character</span>
            </h2>
            <p className="my-6 leading-relaxed text-[#3c5c5c]">
              With their plush, dense coats and round copper eyes, British Shorthairs are the ultimate low‑maintenance lap cat. They're easy‑going, undemanding, and adore quiet family life. These teddy‑bear‑like cats are both dignified and playful.
            </p>
            <div className="flex flex-wrap gap-4 mt-4">
              <span className="bg-[#eef5f2] px-4 py-1.5 rounded-full text-sm font-semibold text-[#2a6b6b]">
                <i className="fas fa-smile"></i> Easygoing
              </span>
              <span className="bg-[#eef5f2] px-4 py-1.5 rounded-full text-sm font-semibold text-[#2a6b6b]">
                <i className="fas fa-home"></i> Loyal
              </span>
              <span className="bg-[#eef5f2] px-4 py-1.5 rounded-full text-sm font-semibold text-[#2a6b6b]">
                <i className="fas fa-fan"></i> Quiet
              </span>
            </div>
            <p className="mt-5">✔️ Weight: 9-17 lbs | Lifespan: 14-20 years</p>
          </div>
      ...
      <div className="max-w-7xl mx-auto my-20 px-6" id="kittens-for-sale">
        <div className="text-center mb-12" data-aos="fade-up">
          ...
          <h2 className="text-[clamp(1.8rem,4vw,2.5rem)] font-bold">Meet Your British Shorthair</h2>
        </div>
              ...
              >
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.target.alt = 'British Shorthair kitten';
                  }}
                />
                {/* Wishlist heart */}
                <div
      ...
      <div className="max-w-5xl mx-auto my-20 px-6">
        <div className="text-center mb-12" data-aos="fade-up">
          ...
          <h2 className="text-[clamp(1.8rem,4vw,2.5rem)] font-bold">British Shorthair Insights</h2>
        </div>
      ...
      <div className="text-center py-8 text-[#8aa9a4]">
        ...
        <p className="mt-8">
          <i className="fas fa-cat"></i> Purrfect British Shorthair Breeder – TICA registered cattery
        </p>
      </div>
